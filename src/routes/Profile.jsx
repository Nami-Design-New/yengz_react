        ...
        <div className="row">
          ...
          <div className="profile-taps col-lg-7 col-12 pe-lg-5 ps-lg-5 pe-0 ps-0">
            ...
            <ul className="nav nav-pills" id="pills-tab" role="tablist">
              ...
              <li className="nav-item" role="presentation">
                <button
                  ...
                  data-bs-toggle="pill"
                  data-bs-target="#pills-verification"
                  type="button"
                  role="tab"
              ...
              <li className="nav-item" role="presentation">
                <button
                  className="nav-link"
                  id="pills-statics-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#pills-statics"
                  type="button"
                  role="tab"
                  aria-controls="pills-statics"
                  aria-selected="false"
                >
                  احصائيات
                </button>
            ...
            <div className="tab-content" id="pills-tabContent">
              ...
              >
                <p>
                  انا خالد عوض مبرمج مواقع بخبرة تفوق الاربع سنوات عملت على كثير
                  من المشاريع وقمت بتنفيذ عدت مواقع لشركات محلية ودولية.
                  =================مميزات العمل معي=================
                  <br />
                  <ul>
                    <li>-توفير خدمة ممتازة وبحودة عالية في وقت قياسي.</li>
                    <li>
                      -توفير خدمة الدعم بعد البيع واستلام مشروعك في حالة ظهور اي
                      شئ.
                    </li>
                    <li>
                      -خبرة جيدة في مجال البرمجة ويمكنني فهم اي خدمات تريدها في
                      مشروعك .
                    </li>
                    <li>
                      -تخصصي ((computer science and artificial intellience)).
                    </li>
                ...
                <div className="rate-card">
                  <div className="rate-owner">
                    ...
                    <p className="rate-text">
                      ...
                      عمركم اذا لم تتعملو معه لانه جدا بعد خدمته تقولون فعلا
                      يستحق التتعامل معه
                    </p>
